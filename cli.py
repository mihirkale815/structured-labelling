...
flags.DEFINE_string("arch", "sa", "arch")
...
flags.DEFINE_integer("n_embed", -1, "n_embed")
flags.DEFINE_integer("d_embed", -1, "d_embed")
flags.DEFINE_integer("dim_hidden", -1, "dim_hidden")
...
flags.DEFINE_string("dev_output", "results/dev.out", "dev_output")
flags.DEFINE_string("test_output", "results/test.out", "test_output")
